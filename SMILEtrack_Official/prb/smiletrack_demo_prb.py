            ...
            for t in online_targets:
                ...
                if tlwh[2] * tlwh[3] > opt.min_box_area:
                    ...
                    if save_img or view_img:  # Add bbox to image
                        ...
                        plot_one_box(tlbr, im0, label=label, color=colors[int(tid) % len(colors)], line_thickness=3)
            p = Path(p)  # to Path
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default='prb=fpn-msp.pt', help='model.pt path(s)')
